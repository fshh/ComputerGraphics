...
// NOTE:    You may add any helper functions you like in the private section.
private:
	...
	bool isPPMFile(std::string fileName);
	// Returns the given int value, clamped to the 0-255 range
	int clampRGB(int val);
};
